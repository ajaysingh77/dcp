...
func (dco *PodmanCliOrchestrator) CaptureContainerLogs(ctx context.Context, container string, stdout io.Writer, stderr io.Writer, options containers.StreamContainerLogsOptions) error {
